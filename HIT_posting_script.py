...
#Insert various urls for the HIT to redirect crowdworkers to
URLS = {
    'url_name': 'YOUR WEBSITE',
}

#It is best practice to store your key_id and access_key in a separate file
#I have called it mykey.key and set it as the default
...
def main(args):
    ...
    if args.action == 'retrieve':
        ...
        new_hit = mturk.create_hit(
            ...
            Keywords = 'INSERT KEYWORKS',
            Reward = 'INSERT REWARD',            #Values are in USD
